...
<div class="wpcp-choose-campaign-wrap">
	<p>Select a campaign to start</p>
	<div class="wpcp-choose-campaign-items">
		<?php
		foreach ( $modules as $module ) {
			$slug = sanitize_title($module['name']);
			$disabled = $module['disabled'] ==  true ? " disabled='disabled' ": '';
			$input = sprintf('<input type="radio" name="_campaign_type" id="%1$s" value="%2$s" %3$s/>', $slug, $slug, $disabled);
	...
	<input type="submit" class="button-secondary button-large" value="Sumbit">
</div>
