    ...
    protected function get_blocks() {
        return [
            [
                ...
                'title'       => __( 'Looking for Something?', 'wpcp' ),
                'desc'        => __( 'We have detailed documentation on every aspects of WP Content Pilot.', 'wpcp' ),
                'url'         => 'https://www.pluginever.com/docs/wp-content-pilot/',
                'button_text' => __( 'Visit the Plugin Documentation', 'wpcp' ),
            ],
            [
                'image'       => WPCP_ASSETS . '/images/help/support.svg',
                'title'       => __( 'Need Any Assistance?', 'wpcp' ),
                'desc'        => __( 'Our EXPERT Support Team is always ready to Help you out.', 'wpcp' ),
                'url'         => 'https://www.pluginever.com/support/',
                'button_text' => __( 'Contact Support', 'wpcp' ),
            ],
            [
                'image'       => WPCP_ASSETS . '/images/help/bugs.svg',
                'title'       => __( 'Found Any Bugs?', 'wpcp' ),
                'desc'        => __( 'OReport any Bug that you Discovered, Get Instant Solutions.', 'wpcp' ),
                'url'         => 'https://github.com/pluginever/wp-content-pilot',
                'button_text' => __( 'Report to Github', 'wpcp' ),
            ],
            [
                'image'       => WPCP_ASSETS . '/images/help/customization.svg',
                'title'       => __( 'Require Customization?', 'wpcp' ),
                'desc'        => __( 'We would Love to hear your Integration and Customization Ideas.', 'wpcp' ),
                'url'         => 'https://www.pluginever.com/contact-us/',
                'button_text' => __( 'Contact Our Services', 'wpcp' ),
            ],
            [
                'image'       => WPCP_ASSETS . '/images/help/like.svg',
                'title'       => __( 'Like The Plugin?', 'wpcp' ),
                'desc'        => __( 'Your Review is very important to us as it helps us to grow more.', 'wpcp' ),
                'url'         => 'https://wordpress.org/support/plugin/wp-content-pilot/reviews/?rate=5#new-post',
                'button_text' => __( 'Review Us on WP.org', 'wpcp' ),
            ],
        ];
    }
}
