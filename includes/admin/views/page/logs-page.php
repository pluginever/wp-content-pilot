...
?>
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Logs', 'wp-content-pilot' ); ?></h1>
	<form method="get" action="<?php echo esc_url( $base_url ); ?>">
		<div class="wpcp-log-table">
			<?php // phpcs:ignore $list_table->search_box( __( 'Search', 'wp-content-pilot' ), 'eaccounting-contacts' ); ?>
