...
<div class="wpcp-choose-campaign-wrap">
	<div class="wpcp-choose-campaign-items">
		...
		foreach ( $modules as $module ) {
			...
			$disabled   = true === $module['disabled'] ? " disabled='disabled' " : '';
			...
			$wrap_class = true === $module['disabled'] ? 'disabled-item' : '';
			printf( '%s', '<div class="wpcp-choose-campaign-item ' . sanitize_html_class( $wrap_class ) . '">' . $input . $label . '</div>' );
		}
		?>
	</div>
	<p class="submit">
		<input type="submit" name="submit" id="submit" class="button button-primary button-large" value="<?php esc_html_e( 'Start Campaign', 'wp-content-pilot' ); ?>">
	</p>
</div>
