...
echo WPCP_HTML::checkbox_input(
	array(
		'label'    => sprintf( __( 'Spin article using using spinrewriter, if you do not have account please %1$ssign up%2$s and set in settings page.', 'wp-content-pilot' ), '<a href="https://bit.ly/spinrewriterpluginever" target="_blank">', '</a>' ),
		'name'     => '_spin_article',
		'required' => false,
	)
);
