				...
				<?php foreach ( $blocks as $block ): ?>
                    <div class="help-block-wrap">
                        <div class="help-block">
                            ...
                            <a target="_blank" href="<?php echo esc_url_raw( $block['url'] ); ?>"
                ...
                <div class="free-vs-pro">
                    ...
                    <table class="widefat">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <a href="https://www.pluginever.com/plugins/wp-content-pilot-pro?utm_source=comparision-chart&utm_medium=button&utm_campaign=content-pilot&utm_content=Go%20Pro"
                                   class="button button-pro" target="_blank">Get Pro</a>
                            </td>
                        </tr>
                    </table>
                </div>
	...
	public function get_features() {
		return [
			...
			[
				...
				'desc'  => __( 'Etsy module to import products & listing', 'wp-content-pilot' ),
				'free'  => false,
				'pro'   => true,
			],
			[
