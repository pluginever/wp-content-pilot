...
class WPCP_Promotion {
	...
	public function promotional_offer() {
		...
		<div class="notice notice-info is-dismissible" id="wpcp-promotional-offer-notice">
			...
			<a href="https://www.pluginever.com/plugins/wp-content-pilot-pro/?utm_source=admin-notice&utm_campaign=getpro&utm_medium=admin-dashboard"
			   class="button button-pro promo-btn" target="_blank"><?php _e( 'Get Pro', 'wp-content-pilot' ); ?></a>
