...
class WPCP_Admin_Notices {
	...
	public static function upgrade_notice() {
		...
		$notice = __( '<b>WP Content Pilot</b> is powering <b>2000+ companies</b> in generating automatic contents and affiliation with its <b>20+</b> types of campaign. Upgrade to Pro now & get 10% discount using coupon <strong>WPCPFREE2PRO</strong>', 'wp-content-pilot' );
