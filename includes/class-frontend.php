...
class Frontend {
	...
	public function enqueue_scripts( $hook ) {
		...
		//styles
		wp_enqueue_style('wp-content-pilot', WPCP_ASSETS_URL."/css/frontend.css", [], WPCP_VERSION);
		
		//scripts
		wp_enqueue_script('wp-content-pilot', WPCP_ASSETS_URL."/js/frontend/frontend{$suffix}.js", ['jquery'], WPCP_VERSION, true);
