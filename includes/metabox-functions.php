...
function wpcp_campaign_advance_settings_metabox_fields($post_id, $campaign_type) {
	echo content_pilot()->elements->input(array(
		...
		'desc'  => 'If you want to limit the title to x characters, input the number above. Default full title.',
	));
	...
	echo content_pilot()->elements->input(array(
		...
		'desc'  => 'If you want to limit the post content to x characters, input the number above. Default full content.',
	));
}
