...
EOT;
	...
	public function discover_links( $source, $campaign_id ) {
		...
		wpcp_logger()->info( sprintf( __( 'Total found links [%1$d] and accepted [%2$d] and reject [%3$d]', 'wp-content-pilot' ), count( $rss_items ), $inserted, ( count( $rss_items ) - $inserted ) ), $campaign_id );
